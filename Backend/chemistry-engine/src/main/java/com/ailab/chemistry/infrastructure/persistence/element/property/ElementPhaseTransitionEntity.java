...
@Entity
@Table(name = "element_phase_transitions", schema = "chemistry")
public class ElementPhaseTransitionEntity {
    @Id
    private UUID id;
    ...
    @Column(name = "temp_k", precision = 10, scale = 4)
    private BigDecimal tempK;
    ...
    public ElementPhaseTransitionEntity() {}
    ...
    public BigDecimal getTempK() { return tempK; }
    public void setTempK(BigDecimal tempK) { this.tempK = tempK; }
