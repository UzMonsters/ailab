...
export type ScenarioHintType = 'TEXT' | 'HIGHLIGHT' | 'ARROW' | 'GHOST_PLACEMENT' | 'CONNECT_PORTS' | 'VIDEO' | 'IMAGE' | 'OPEN_TAB' | 'HIGHLIGHT_TAB' | 'HIGHLIGHT_EQUIPMENT' | 'HIGHLIGHT_MATERIAL' | 'HIGHLIGHT_OBJECT' | 'HIGHLIGHT_PORT' | 'SHOW_ARROW' | 'GHOST_PLACE_OBJECT' | 'FOCUS_CAMERA';
