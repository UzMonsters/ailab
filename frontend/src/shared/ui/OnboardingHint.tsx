...
export default function OnboardingHint({ storageKey }: OnboardingHintProps) {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[200] px-5 py-3 bg-[var(--card)] border border-[var(--border)] rounded-xl shadow-[0_10px_40px_rgba(0,0,0,.3)] flex items-center gap-3 text-sm text-[var(--foreground)]">
