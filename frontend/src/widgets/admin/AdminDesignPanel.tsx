...
const copy: Record<Domain, Record<string, { eyebrow: string; title: string; description: string; fields: string[]; metrics: [string, string][] }>> = {
  equipment: {
    ...
    Localization: { eyebrow: 'Translation desk', title: 'Localized equipment copy', description: 'Review display names, descriptions and safety labels by language.', fields: ['Русский · Complete', 'O‘zbekcha · Needs review', 'English · Complete'], metrics: [['Coverage', '92%'], ['Strings', '27'], ['Warnings', '1']] },
  ...
  scenario: {
    ...
    Localization: { eyebrow: 'Translation desk', title: 'Scenario language coverage', description: 'Keep instructions, hints and result messages aligned.', fields: ['Русский · 34 / 34 strings', 'O‘zbekcha · 31 / 34 strings', 'English · 34 / 34 strings'], metrics: [['Coverage', '97%'], ['Review', '3'], ['Locales', '3']] },
  ...
  level: {
    ...
    localization: { eyebrow: 'Translation desk', title: 'Level language coverage', description: 'Compare lesson copy and learning objectives across locales.', fields: ['Русский · Complete', 'O‘zbekcha · 88% complete', 'English · Complete'], metrics: [['Coverage', '96%'], ['Strings', '42'], ['Review', '5']] },
