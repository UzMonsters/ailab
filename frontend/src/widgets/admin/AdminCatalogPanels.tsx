...
const learningCopy: Record<string, { title: string; subtitle: string; stats: [string, string][]; rows: [string, string, string][] }> = {
  ...
  localization: { title: 'Localization coverage', subtitle: 'Review curriculum readiness across the three product languages.', stats: [['Coverage', '94%'], ['Needs review', '87'], ['Locales', '3']], rows: [['Русский', '1,842 / 1,842 strings', 'Complete'], ['O‘zbekcha', '1,701 / 1,842 strings', 'Review'], ['English', '1,829 / 1,842 strings', 'Near complete']] },
};
