    ...
    <div className="relative min-h-screen" style={{ backgroundColor: '#050508' }}>
      ...
      <header className="relative z-20 border-b border-white/5 bg-[#050508]/80 backdrop-blur-xl">
        <div className="max-w-[1380px] mx-auto px-5 h-16 flex items-center justify-between">
          ...
          <nav className={`lg:flex items-center gap-8 ${menuOpen ? 'flex flex-col absolute top-16 left-0 right-0 bg-[#050508]/95 border-b border-white/5 p-6 space-y-3' : 'hidden lg:flex'}`}>
